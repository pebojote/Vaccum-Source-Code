const user = [
    {
        id: 0, // post
        image: require('../assets/images/1-demo-user.png'), // post // profile
        name: "Kitchen", // post 
        author: { // post // profile
            first: "Edison",
            last: "Pebojot",
        ...
        date: "January 1, 2021", // post
        day: "Friday", // post
        hour: 2, // post
        location: "Paltic", // post // profile
        reward: 200.00, // post
        cleaner: 21, // post
        description: "As a cleaner, you will work in kitchen", // post
        task: [
    ...
    },
    {
        ...
        task: [
            ...
            { label: "Clean out dryer" },
            { label: "Reorganize supplies" }
        ]
    }
]
