...
export default class CreateJob extends React.Component {
    ...
    onSubmit() {
        ...
        const usersCOL = Library.firestore().collection("users");
        const madeCOL = usersCOL.doc(id).collection("made");
        const made = madeCOL.add
            (
                {
                    name: this.state.job,
                    reward: this.state.bounty,
        ...
        made.then(this.onMade.bind(this));
    }

    onMade(resolve, reject) {
        if (resolve) {
